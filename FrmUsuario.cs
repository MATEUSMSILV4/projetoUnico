...
namespace projetoUnico
{
    public partial class FrmUsuario : Form
    {
        ...
        private void btnSalvar_Click(object sender, EventArgs e)
        {
            ...
            con.Abrirconexao();
            sql = "INSERT INTO  login (nome,Cpf,senha,Nivel_Acesso) VALUES (@nome,@Cpf,@senha,@Nivel_Acesso)";
            cmd = new MySqlCommand(sql, con.con);
            cmd.Parameters.AddWithValue("@nome", txtNome.Text);
            cmd.Parameters.AddWithValue("@Cpf", txtCpf.Text);
            cmd.Parameters.AddWithValue("@senha", txtSenha.Text);
            cmd.Parameters.AddWithValue("@Nivel_Acesso", txtAcesso.Text);
        ...
        private void btnAtualizar_Click(object sender, EventArgs e)
        {
            ...
            con.Abrirconexao();
            sql = "UPDATE login SET nome=@nome, Cpf=@Cpf, senha=@senha, Nivel_Acesso=@Nivel_Acesso";
            sql += " WHERE Id=@Id";
            cmd = new MySqlCommand(sql, con.con);
            ...
            if (!string.IsNullOrEmpty(txtCpf.Text)) // Verifica se o campo de CPF foi preenchido
            {
                MySqlCommand cmdverifica;
                cmdverifica = new MySqlCommand("SELECT * FROM login WHERE Cpf = @Cpf", con.con);
                MySqlDataAdapter da = new MySqlDataAdapter();
                ...
                if (dt.Rows.Count > 0)
                {
                    MessageBox.Show("Usuário já cadastrado", "Salvar", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                    txtCpf.Text = "";
                    txtCpf.Focus();
        ...
        private void GridUser_Click(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex > -1)
            {
                ...
                txtAcesso.Text = GridUser.CurrentRow.Cells[4].Value.ToString();
        ...
        private void FormatarGD()
        {
            ...
            GridUser.Columns[4].HeaderText = "Acesso";
        }
